...
function puzzleA() {
    showPuzzle();
    var pg = new puzzleGame( '#imgArea', 'images/a.jpg' );
    checkStart(pg);    
    
}
function puzzleB() {
    showPuzzle();
    var pg = new puzzleGame( '#imgArea', 'images/b.jpg' );
    checkStart(pg); 
}
function puzzleC() {
    showPuzzle();
    var pg = new puzzleGame( '#imgArea', 'images/c.jpg' );
    checkStart(pg); 
}
function puzzleD() {
    showPuzzle();
    var pg = new puzzleGame( '#imgArea', 'images/d.jpg' );
    checkStart(pg); 
}
function puzzleE() {
    showPuzzle();
    var pg = new puzzleGame( '#imgArea', 'images/e.jpg' );
    checkStart(pg); 
}
function puzzleF() {
    showPuzzle();
    var pg = new puzzleGame( '#imgArea', 'images/f.jpg' );
    checkStart(pg); 
}
